...
const navItems = [
  ...
  { label: 'Blockchain', path: '/blockchain', icon: 'key', roles: ['admin', 'auditor'] },
  ...
  { label: 'Verify Receipt', path: '/verify-receipt', icon: 'records', roles: ['patient', 'doctor', 'nurse', 'admin', 'auditor'] },
  { label: 'Settings', path: '/settings', icon: 'key', roles: ['patient', 'doctor', 'nurse', 'admin', 'auditor'] },
]
